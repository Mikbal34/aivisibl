        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex justify-center mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-xl border border-white/20">
              ...
              <span className="text-sm font-semibold bg-gradient-to-r from-purple-400 to-pink-400 text-transparent bg-clip-text">
          ...
          <motion.div variants={itemVariants} className="text-center mb-12">
            <h1 className="text-6xl md:text-8xl font-black text-white mb-6 leading-[1.1] tracking-tight">
              Decode Your
              <span className="block mt-2 bg-gradient-to-r from-purple-400 via-pink-400 to-purple-400 text-transparent bg-clip-text animate-gradient">
                Brand DNA
              </span>
            </h1>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { value: '100%', label: 'AI Accuracy', icon: Target, color: 'from-purple-400 to-pink-400' },
                { value: '<15s', label: 'Analysis Time', icon: Zap, color: 'from-blue-400 to-cyan-400' },
                { value: '6', label: 'Dimensions', icon: TrendingUp, color: 'from-green-400 to-emerald-400' },
              ].map((stat, i) => (
                <div key={i} className="text-center">
                  <div className="flex items-center justify-center gap-3 mb-2">
                    <stat.icon className={`w-8 h-8 bg-gradient-to-r ${stat.color} text-transparent`} style={{ WebkitTextFillColor: 'transparent', WebkitBackgroundClip: 'text' }} />
                    <motion.div
                      className={`text-5xl font-black bg-gradient-to-r ${stat.color} text-transparent bg-clip-text`}
                      initial={{ scale: 0.5 }}
                      animate={{ scale: 1 }}
